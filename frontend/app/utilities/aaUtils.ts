...
/**
 * Get provider instance for Design By Bid
 */
...
// =================================================================
  ...
  milestones: ethers.BigNumberish[],
  paymentType: number = 0,
  selectedToken: string = '',
  options?: {
    apiKey?: string;
  ...
  try {
    return await executeOperation(
      ...
      ABI,
      'postProject',
      [description, budget, deadline, milestones],
      paymentType,
      selectedToken,
      options
    );
...
export const raiseDispute = async (
  ...
  try {
    ...
    console.error(`Error raising dispute for project ${projectId}:`, error);
    throw error;
  }
};
...
export const releaseMilestonePayment = async (
  accountSigner: ethers.Signer,
  projectId: ethers.BigNumberish,
  milestoneIndex: ethers.BigNumberish,
  paymentType: number = 0,
  selectedToken: string = '',
  options?: {
    apiKey?: string;
  ...
  try {
    ...
    console.error(
      `Error releasing milestone ${milestoneIndex} for project ${projectId}:`,
      error
    );
    throw error;
  }
...
export const selectBid = async (
  ...
  try {
    ...
    console.error(`Error selecting bid ${bidIndex} for project ${projectId}:`, error);
    throw error;
  }
};
...
export const submitBid = async (
  ...
  completionTime: ethers.BigNumberish,
  proposedMilestones: ethers.BigNumberish[],
  paymentType: number = 0,
  selectedToken: string = '',
  options?: {
    apiKey?: string;
  ...
  try {
    return await executeOperation(
      ...
      ABI,
      'submitBid',
      [projectId, bidAmount, completionTime, proposedMilestones],
      paymentType,
      selectedToken,
      options
    );
